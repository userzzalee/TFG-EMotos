<x-guest-layout>
    <div class="min-h-screen bg-black flex flex-col items-center justify-start pt-[70px]">
        ...
        <div class="mt-8 text-white flex items-center gap-4">
            ...
            <a href="{{ route('login') }}" class="text-white bg-[rgb(34,34,34)] px-4 py-2 no-underline hover:bg-black transition-colors rounded">
                Iniciar sesión
            </a>
        </div>

        <div class="mt-4">
            <a href="{{ url('/') }}" class="text-gray-400 no-underline hover:text-white transition-colors">
                Volver al inicio
            </a>
        </div>
