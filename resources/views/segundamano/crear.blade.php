...
<main class="relative z-10 text-white pt-[100px] pb-20">
    <div class="max-w-2xl mx-auto px-8">
        ...
        <h1 class="text-4xl font-light tracking-[0.3em] mb-8 text-center uppercase">Nuevo Anuncio</h1>
        ...
        <form action="{{ route('segundamano.store') }}" method="POST"
            ...
            {{-- Imagen --}}
            <div>
                <label class="block text-xs tracking-widest text-gray-400 mb-3 uppercase">Imagen</label>
                <div class="border-2 border-dashed border-gray-700 rounded-lg p-8 text-center hover:border-yellow-500 transition-all">
                    ...
                    <p class="text-gray-600 text-xs mt-3">JPEG, PNG, GIF · Máx 3 MB · Opcional</p>
                </div>
            </div>
