...
<main class="relative z-10 text-white pt-[75px] pb-20">
    <div class="max-w-2xl mx-auto px-4 sm:px-8">
        ...
        <h1 class="text-xl sm:text-2xl font-light tracking-[0.2em] mb-6 text-center uppercase">Nuevo Anuncio</h1>
        ...
        <form action="{{ route('segundamano.store') }}" method="POST" enctype="multipart/form-data" class="space-y-4">
            ...
            <div>
                ...
                <input type="text" name="titulo" value="{{ old('titulo') }}" required
                       class="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-2 text-white text-sm focus:border-yellow-500 focus:outline-none transition-all"
            ...
            <div>
                ...
                <textarea name="descripcion" rows="3"
                          class="w-full bg-gray-900 border border-gray-700 rounded-lg px-4 py-2 text-white text-sm focus:border-yellow-500 focus:outline-none transition-all resize-none"
            ...
            <div>
                ...
                <div class="border-2 border-dashed border-gray-700 rounded-lg p-4 text-center hover:border-yellow-500 transition-all">
                    <input type="file" name="imagenes[]" multiple accept="image/jpeg,image/png,image/jpg,image/gif"
                           class="w-full text-gray-400 text-sm file:mr-4 file:py-1 file:px-3 file:rounded-lg file:border-0 file:bg-gray-800 file:text-yellow-500 file:cursor-pointer hover:file:bg-gray-700 transition-all">
                    <p class="text-gray-600 text-xs mt-2">JPEG, PNG · Máx 3 MB · Hasta 8 imágenes · La primera será la portada</p>
                </div>
            ...
            <div class="flex gap-3 pt-2">
                <a href="{{ route('segundamano.index') }}"
                   class="flex-1 bg-gray-800 text-white py-2 rounded-lg text-center text-xs tracking-widest uppercase hover:bg-gray-700 transition-all">
                   Cancelar
                </a>
                <button type="submit"
                        class="flex-1 bg-yellow-500 text-black py-2 rounded-lg text-xs tracking-widest uppercase font-medium hover:bg-yellow-400 transition-all">
                    Publicar
                </button>
            </div>
        </form>
