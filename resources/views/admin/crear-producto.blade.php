        ...
        <form action="{{ route('merchandising.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div>
                ...
                <input type="text" 
                       name="nombre" 
                       required
                       class="w-full bg-gray-900 border border-gray-700 rounded-lg px-6 py-4 text-white focus:border-yellow-500 focus:outline-none transition-all"
            ...
            <div>
                ...
                <textarea name="descripcion" 
                          rows="4"
                          class="w-full bg-gray-900 border border-gray-700 rounded-lg px-6 py-4 text-white focus:border-yellow-500 focus:outline-none transition-all resize-none"
            ...
            <div>
                ...
                <div class="border-2 border-dashed border-gray-700 rounded-lg p-8 text-center hover:border-yellow-500 transition-all cursor-pointer">
                    <input type="file" 
                           ...
                           required
                           class="w-full text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:bg-gray-800 file:text-yellow-500 file:cursor-pointer hover:file:bg-gray-700 transition-all">
            ...
            <div class="flex gap-4 pt-4">
                <a href="{{ route('merchandising') }}" 
                   class="flex-1 bg-gray-800 text-white py-4 rounded-lg text-center tracking-widest hover:bg-gray-700 transition-all">
                    CANCELAR
                </a>
                <button type="submit" 
                        class="flex-1 bg-yellow-500 text-black py-4 rounded-lg tracking-widest font-medium hover:bg-yellow-400 transition-all">
                    GUARDAR
                </button>
            </div>
        </form>
