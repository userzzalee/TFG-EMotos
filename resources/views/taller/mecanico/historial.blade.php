...
<div class="overflow-x-auto -mx-4 sm:mx-0">
    <table class="w-full text-xs min-w-[480px] px-4 sm:px-0">
        <thead>
            <tr class="border-b border-white/10 text-white/30 text-[10px] uppercase tracking-widest">
                <th class="text-left pb-2 pr-3 font-normal pl-4 sm:pl-0">Vehículo</th>
                ...
                <th class="text-right pb-2 font-normal pr-4 sm:pr-0">Estado</th>
            </tr>
        </thead>
        <tbody>
            @forelse($citas as $cita)
                <tr class="border-b border-white/[.06] hover:bg-white/[.02] transition-colors">
                    <td class="py-2.5 pr-3 pl-4 sm:pl-0">
                    ...
                    <td class="py-2.5 pr-3 text-white/40 text-xs whitespace-nowrap">{{ $cita->updated_at->format('d/m/Y') }}</td>
                    <td class="py-2.5 pr-3 text-right font-semibold text-white text-xs whitespace-nowrap">{{ number_format($cita->coste, 2) }} €</td>
            ...
            @empty
                <tr>
                    <td colspan="5" class="py-12 text-center text-white/20 text-xs uppercase tracking-widest">Sin historial aún</td>
                </tr>
            @endforelse
        </tbody>
    </table>
